-- Potrebići Project - initial seed data
...
values (
  ...
  'Moderan stambeno-poslovni objekat na početku Telepa u Novom Sadu.',
  '064 227 9117',
...
values (
  ...
  'Projekat M & M Gradnja objedinjuje stanove, poslovne apartmane, lokale, garažna i dvorišna parking mesta, uz jasan prodajni pregled dostupnih jedinica.',
  'Moderan stambeno-poslovni objekat na početku Telepa, osmišljen za miran život uz brzu vezu sa gradom.',
  'Projekat M & M Gradnja objedinjuje stanove, poslovne apartmane, lokale, garažna i dvorišna parking mesta, uz jasan prodajni pregled dostupnih jedinica.',
  'Početak Telepa je praktičan izbor za kupce koji žele mirniji stambeni ambijent, ali i brzu vezu sa centrom, školama, trgovinom i rekreativnim zonama uz Dunav.',
  'PO + P + 3',
  date '2026-03-16',
  date '2027-11-15',
  15,
...
unit_rows as (
  select *
  from (values
    ('1',  'stan-1',  1, '1. etaža', 62.15, 'Trosoban', '2 kupatila', 'Terasa', 'Veći stan sa dva kupatila, pogodan za porodicu.'),
    ('2',  'stan-2',  1, '1. etaža', 58.26, 'Trosoban', '2 kupatila', 'Terasa', 'Trosoban stan sa dobrim odnosom komfora i kvadrature.'),
    ('3',  'stan-3',  1, '1. etaža', 28.55, 'Garsonjera', '1 kupatilo', 'Bez terase', 'Kompaktan stan i jedini tip bez terase.'),
    ('4',  'stan-4',  1, '1. etaža', 46.95, 'Dvosoban', '1 kupatilo', 'Terasa', 'Praktičan dvosoban stan sa terasom.'),
    ('5',  'stan-5',  1, '1. etaža', 42.57, 'Dvosoban', '1 kupatilo', 'Terasa', 'Manji dvosoban stan sa jasnim rasporedom.'),
    ('6',  'stan-6',  2, '2. etaža', 60.29, 'Trosoban', '2 kupatila', 'Terasa', 'Veći stan sa dva kupatila, pogodan za porodicu.'),
    ('7',  'stan-7',  2, '2. etaža', 56.50, 'Trosoban', '2 kupatila', 'Terasa', 'Trosoban stan sa dobrim odnosom komfora i kvadrature.'),
    ('8',  'stan-8',  2, '2. etaža', 27.69, 'Garsonjera', '1 kupatilo', 'Bez terase', 'Kompaktan stan i jedini tip bez terase.'),
    ('9',  'stan-9',  2, '2. etaža', 45.54, 'Dvosoban', '1 kupatilo', 'Terasa', 'Praktičan dvosoban stan sa terasom.'),
    ('10', 'stan-10', 2, '2. etaža', 41.29, 'Dvosoban', '1 kupatilo', 'Terasa', 'Manji dvosoban stan sa jasnim rasporedom.'),
    ('11', 'stan-11', 3, '3. etaža', 60.29, 'Trosoban', '2 kupatila', 'Terasa', 'Veći stan sa dva kupatila, pogodan za porodicu.'),
    ('12', 'stan-12', 3, '3. etaža', 56.50, 'Trosoban', '2 kupatila', 'Terasa', 'Trosoban stan sa dobrim odnosom komfora i kvadrature.'),
    ('13', 'stan-13', 3, '3. etaža', 27.69, 'Garsonjera', '1 kupatilo', 'Bez terase', 'Kompaktan stan i jedini tip bez terase.'),
    ('14', 'stan-14', 3, '3. etaža', 45.54, 'Dvosoban', '1 kupatilo', 'Terasa', 'Praktičan dvosoban stan sa terasom.'),
    ('15', 'stan-15', 3, '3. etaža', 41.29, 'Dvosoban', '1 kupatilo', 'Terasa', 'Manji dvosoban stan sa jasnim rasporedom.')
...
select
  ...
  '["Podno grejanje", "Lift od podzemne garaže do svih spratova", "Garažno mesto dostupno za odvojenu kupovinu", "Ostava dostupna za odvojenu kupovinu"]'::jsonb,
...
media_rows(unit_code, title, media_type, file_path, alt_text, description, sort_order, is_published) as (
  values
    (null, 'Heroja Pinkija 13 - generisani render fasade', 'project_image'::public.project_media_type, '/images/heroja-pinkija-13/hero-generated.png', 'Generisani render fasade projekta Heroja Pinkija 13', 'Glavna projektna slika za hero i homepage portfolio sekcije.', 1, true),
    (null, 'Heroja Pinkija 13 - render fasade', 'project_image'::public.project_media_type, '/images/heroja-pinkija-13/gradilisna-tabla-slika.jpg', 'Render fasade projekta Heroja Pinkija 13', 'Rezervna projektna fotografija za buduće sekcije.', 2, false),
    ...
    ('1', 'Tlocrt stana 1', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-1-6-11.png', 'Tlocrt stana 1 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 101, true),
    ('2', 'Tlocrt stana 2', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-2-7-12.png', 'Tlocrt stana 2 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 102, true),
    ('3', 'Tlocrt stana 3', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-3-8-13.png', 'Tlocrt stana 3 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 103, true),
    ('4', 'Tlocrt stana 4', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-4-9-14.png', 'Tlocrt stana 4 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 104, true),
    ('5', 'Tlocrt stana 5', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-5-10-15.png', 'Tlocrt stana 5 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 105, true),
    ('6', 'Tlocrt stana 6', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-1-6-11.png', 'Tlocrt stana 6 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 106, true),
    ('7', 'Tlocrt stana 7', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-2-7-12.png', 'Tlocrt stana 7 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 107, true),
    ('8', 'Tlocrt stana 8', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-3-8-13.png', 'Tlocrt stana 8 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 108, true),
    ('9', 'Tlocrt stana 9', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-4-9-14.png', 'Tlocrt stana 9 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 109, true),
    ('10', 'Tlocrt stana 10', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-5-10-15.png', 'Tlocrt stana 10 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 110, true),
    ('11', 'Tlocrt stana 11', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-1-6-11.png', 'Tlocrt stana 11 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 111, true),
    ('12', 'Tlocrt stana 12', 'unit_image'::public.project_media_type, '/images/apartment-plans/stan-2-7-12.png', 'Tlocrt stana 12 u projektu Heroja Pinkija 13', 'Tlocrt za detalj stana i poređenje prostorija.', 112, true),
...
from project,
(values
  ('Gradilište', 'Objekat je u fazi izgradnje', 'Pregled projekta je pripremljen za redovno objavljivanje novih informacija, fotografija i statusa radova.', 'Aktuelno', 'active', 1),
  ('stanovi', 'Prodaja stanova je počela', 'U ponudi je 15 stanova sa ponavljajućim rasporedima po etažama i jasnim kontaktom za svaki upit.', 'Prodaja', 'active', 2),
  ('Plan', 'Planirani završetak je 15. novembar 2027.', 'Timeline prikazuje najvažnije faze gradnje i daje kupcima jednostavan pregled razvoja projekta.', 'Rok', 'upcoming', 3)
...
values (
  ...
  '["Plac ili kuća za rusenje", "Novi Sad i bliža okolina", "stambena namena", "Pravno čista situacija"]'::jsonb,
  '["Pošaljite osnovne podatke o parceli, kući ili lokaciji.", "Nas tim proverava potencijal lokacije i kontaktira vas za dodatne informacije.", "Dogovaramo sledeći korak, procenu i uslove saradnje."]'::jsonb,
  'Pošaljite ponudu',
  'Kupujemo placeve - M & M Gradnja',
  'Pošaljite ponudu za plac ili kuću pogodnu za buduću stambenu izgradnju.',
  true
)
on conflict (id) do update set
